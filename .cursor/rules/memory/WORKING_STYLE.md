...
| Liquidation framing precision | 1 | 2026-03-24 | Never equate gross liquidated collateral with economic loss. Forced sale is mostly value-neutral (collateral→debt repayment); actual loss is the penalty (~5%) plus conditional recovery opportunity cost. → `TECHNICAL.md § Liquidated Collateral vs. Economic Loss`. Applies to all docs, charts, and analysis. |
